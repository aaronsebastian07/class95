        ...
        return(
          <KeyboardAvoidingView behavior="padding" style={styles.container}>
            <View>
              ...
              <Text style={{textAlign: 'center', fontSize: 30}}>Wellness Tips Page (enter a wellness tip you would like to recieve)</Text>
            </View>
            <View style={styles.inputView}>
            <TextInput 
              style={styles.inputBox}
              placeholder="Wellness Tip Category"
              onChangeText={(text)=>{
                this.setState({
                  scannedBookId: text
                })
            ...
            <TextInput 
              style={styles.inputBox}
              placeholder="Author/Fitness Instructor Name"
              onChangeText={(text)=>{
                this.setState({
